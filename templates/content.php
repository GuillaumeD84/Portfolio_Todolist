  ...
  <div id="container">
    ...
    <header id="filterTasks">
      ...
      <div class="actions">
        ...
        --><span class="<?= isset($_SESSION['finish']) && $_SESSION['finish'] === 'no' ? 'active' : ''?>"><a href="?finish=no">Todo</a></span><!--
        --><span class="<?= isset($_SESSION['finish']) && $_SESSION['finish'] === 'yes' ? 'active' : ''?>"><a href="?finish=yes">Completed</a></span>
      </div>
    </header>
